...
- [x] **Refactor OpenRouter as Provider**
...
- [x] **Update Settings Type for Multi-Provider**
...
- [x] **Update Settings Store for Providers**
...
- [x] **Update useAI Hook for Abstraction**
...
- [x] **Add sourceThoughtId to Task Type**
...
- [x] **Add linkedTaskIds to Thought Type**
...
- [x] **Refactor Capture Flow - Always Create Thought**
...
- [x] **Create Background AI Processor Hook**
...
- [x] **Integrate Background AI into App**
...
- [x] **Update Capture Modal for Thought-First**
...
- [x] **Update Voice Transcription Prompt**
...
- [x] **Simplify Voice Processing Result**
...
- [x] **Update Voice Prompt for Single Output**
...
- [x] **Create Auto-Recommendations Hook**
...
- [x] **Refactor WhatToDoNext for Auto-Load**
...
- [x] **Add Fallback for No-AI Inbox**
...
- [x] **Remove ContextInput Requirement**
...
- [x] **Add Keyboard Navigation to TaskList**
...
- [x] **Add Keyboard Navigation to ThoughtsList**
...
- [x] **Add Keyboard Navigation to Inbox**
...
- [x] **Create Yandex Settings Section**
...
- [x] **Add Provider Status Indicator**
...
- [x] **Update All AI-Dependent Components**
...
- [x] **Queue Unprocessed Thoughts for Later**
...
- [x] **Update Task Extractor for Auto-Apply**
  ...
  > **Note**: Already implemented - useBackgroundAI directly applies values to tasks.

- [x] **Update Property Suggester for Auto-Apply**
  ...
  > **Note**: Already implemented - values are extracted and applied directly in background processing.

- [x] **Clean Up Unused Suggestion Code**
  ...
  > **Note**: Types retained for backward compatibility, but flow simplified - AI auto-applies values.

- [x] **Add Thought-Task Link UI**
...
- [x] **Integration Testing Checklist**
  ...
  > **Status**: Build passes. Pre-existing lint warnings remain in unchanged files.
