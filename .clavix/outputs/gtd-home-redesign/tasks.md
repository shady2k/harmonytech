...
- [ ] **Add ProcessingStatus type to Thought** (ref: Data Migration Strategy)
...
- [ ] **Add ClassificationStatus type to Task** (ref: Data Migration Strategy)
...
- [ ] **Update Thought RxDB schema to version 1** (ref: Data Migration Strategy)
...
- [ ] **Update Task RxDB schema to version 1** (ref: Data Migration Strategy)
...
- [ ] **Create schema migration strategies** (ref: Data Migration Strategy)
...
- [ ] **Register migrations in database.ts** (ref: Data Migration Strategy)
...
- [ ] **Create AI constants file** (ref: AI Confidence Thresholds)
...
- [ ] **Add aiEnabled setting to settings store** (ref: AI Disabled Mode)
...
- [ ] **Update settings schema for new fields** (ref: AI Disabled Mode)
...
- [ ] **Add confidence calculation to useBackgroundAI** (ref: AI Confidence Thresholds)
...
- [ ] **Add processingStatus state management** (ref: Core Implementation)
...
- [ ] **Implement retry with exponential backoff** (ref: Failure & Offline States)
...
- [ ] **Add aiEnabled check to background processing** (ref: AI Disabled Mode)
...
- [ ] **Add offline detection** (ref: Failure & Offline States)
...
- [ ] **Update navigation constants** (ref: Navigation Restructure)
...
- [ ] **Add NavItem badge support** (ref: Core Implementation)
...
- [ ] **Update App.tsx routing** (ref: Navigation Restructure)
...
- [ ] **Create useInbox hook** (ref: Technical Requirements)
...
- [ ] **Add inbox count to navigation state** (ref: UX Polish)
...
- [ ] **Export useInbox from hooks index** (ref: Technical Requirements)
...
- [ ] **Create InboxView component** (ref: True Inbox View)
...
- [ ] **Create QuickProcessCard component** (ref: True Inbox View)
...
- [ ] **Create EmptyInboxState component** (ref: UX Polish)
...
- [ ] **Create InboxAlertBanner component** (ref: Home Dashboard)
...
- [ ] **Create inbox components index** (ref: Technical Requirements)
...
- [ ] **Add InboxAlertBanner to WhatToDoNext** (ref: Home Dashboard)
...
- [ ] **Add "Why this task?" reasoning display** (ref: Home Dashboard)
...
- [ ] **Implement Approve action** (ref: True Inbox View)
...
- [ ] **Implement Edit action** (ref: True Inbox View)
...
- [ ] **Implement Dismiss action** (ref: True Inbox View)
...
- [ ] **Implement Retry action** (ref: True Inbox View)
...
- [ ] **Create performance utilities** (ref: Performance Metrics)
...
- [ ] **Add performance measurement to Home** (ref: Performance Metrics)
...
- [ ] **Create analytics event helpers** (ref: Analytics Implementation)
...
- [ ] **Add analytics to inbox actions** (ref: Analytics Implementation)
...
- [ ] **Add offline banner component** (ref: Failure & Offline States)
...
- [ ] **Add processing animations** (ref: UX Polish)
...
- [ ] **Manual test: Schema migration** (ref: Data Migration Strategy)
...
- [ ] **Manual test: Confidence-based flow** (ref: AI Confidence Thresholds)
...
- [ ] **Manual test: Offline behavior** (ref: Failure & Offline States)
...
- [ ] **Manual test: Navigation & routing** (ref: Navigation Restructure)
...
- [ ] **Run lint and build** (ref: Project Guidelines)
